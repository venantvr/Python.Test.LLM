...
def camembert_bio_generalized(symptome1, symptome2):
    # Charger le modèle CamemBERT-Bio pour les textes médicaux
    model_name = "medkit/CamemBert-Bio-Generalized"
...
if __name__ == "__main__":
    ...
    similarity_score = camembert_bio_generalized(symptome1, symptome2)
